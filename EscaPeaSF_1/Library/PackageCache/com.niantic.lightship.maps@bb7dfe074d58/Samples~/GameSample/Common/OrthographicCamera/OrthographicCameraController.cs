...
using System;
using Niantic.Lightship.Maps.Samples.Common.Input;
...
namespace Niantic.Lightship.Maps.Samples.Common.OrthographicCamera
{
    /// <summary>
    ...
    public class OrthographicCameraController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Assert.That(_map.IsMapCenteredAtOrigin);
