...
namespace Niantic.Lightship.Maps.Unity.Builders.Areas
{
    /// <summary>
    /// A builder for <see cref="AreaFeature"/>s
    /// </summary>
    [CreateAssetMenu(fileName = "NewGeneralAreaBuilder", menuName = "Lightship Maps/Builders/General Area Builder")]
    public class AreaFeatureBuilder : MeshBuilder
    {
        /// <inheritdoc />
