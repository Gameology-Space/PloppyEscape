...
namespace Niantic.Lightship.Maps.Unity.Core
{
    ...
    public class MapUnitConverter
    {
        ...
        /// <summary>
        /// Convert between unity scene units to meters in the real world
        /// Note that latitude is required here because our map uses web mercator projection,
        /// which causes distances to stretch as you approach the poles
        /// A reasonable value for this would be the latitude at the map origin
        /// </summary>
        ...
        /// <summary>
        /// Convert between meters in the real world to unity scene units
        /// Note that latitude is required here because our map uses web mercator projection,
        /// which causes distances to stretch as you approach the poles
        /// </summary>
