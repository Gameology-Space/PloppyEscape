...
{
    /// <summary>
    /// This interface contains all of the members of <see cref="LightshipMap"/>'s public API.
    /// </summary>
    [PublicAPI]
    public interface ILightshipMap
    {
        ...
        /// </summary>
        event Action<IMapTile, MapTileObject> MapTileAdded;

        /// <summary>
        /// Event that's raised when an <see cref="IMapTile"/> is no longer in view,
        /// just before its <see cref="MapTileObject"/> is returned to the pool.
        /// </summary>
        event Action<IMapTile, MapTileObject> MapTileRemoved;
        ...
        /// <summary>
        /// This method is called to offset the LightshipMap's position.
        /// </summary>
        /// <param name="offset">The offset, in Unity's world space.</param>
        void OffsetMapCenter(Vector3 offset);

        /// <summary>
        /// This method is called to update the LightshipMap's position
        ...
        /// </summary>
        /// <param name="mapRadius">The map's viewable radius, in meters.</param>
        void SetMapRadius(double mapRadius);

        /// <summary>
        /// This method is called to update the LightshipMap's position and
        /// viewable radius (in response to changes in the device's GPS or
        /// if the map is zoomed in or out, for example).
        /// </summary>
        /// <param name="latLng">The map's center, in lat/lng coordinates.</param>
        /// <param name="mapRadius">The map's viewable radius, in meters.</param>
